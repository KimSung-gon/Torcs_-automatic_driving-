...
@REM   i.e.   ${workspace_loc:torcs}/make_launcher.bat
...
@set ERIKA_FILES=C:\EE_RT-Druid-2.4.0-juno-win32-x86_64\eclipse\plugins\com.eu.evidence.ee_2.4.0.20141105_0021\ee_files
